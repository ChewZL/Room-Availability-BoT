# [Bosch hackathon](http://startbootstrap.com/) - [Room Availability BoT](http://startbootstrap.com/template-overviews/sb-admin/)

[Bosch BoT hackathon](http://startbootstrap.com/template-overviews/sb-admin/) is a hackathon for students to create an IoT solution that makes buildings smarter [Bootstrap](http://getbootstrap.com/) created by [Start Bootstrap](http://startbootstrap.com/).
